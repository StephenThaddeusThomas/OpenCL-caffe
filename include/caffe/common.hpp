// File:common.hpp
// Date:160307
// 160307 : Stage2 integration of ADNN code.  ADNN LIbrary now created with Caffe constructor
// 160220 : Notes on what to do for Alex library integration (search TT:) 
...
namespace gflags = google; // Alias 
#endif

// Disable the copy and assignment operator for a class.
// TT: don't we also need to have { } 
...
//the following are macro defines for optimization schemes in conv layer
...
// TT:160228 : FirstVersion - going to also initialized Alex's ADNN Library
// For this first version going to have the library instance a GLOBAL pointer
// and ONLY in common.cpp - Next step (if that compiles and links) is to find a
// location within Caffe class to keep and have it carried around.
