...
// This is a relative path from bin.  My file system: MLopen/adnn and in adnn there is bin/ src/ lib/ inc/ obj/ ocl/ all at the same level
// src/ holds the code for the librar
// lib/ holds the library (and its also put in a global MLopen/lib
// inc/ for those includes that should be public to clients of this library 
// This really should become a command line argument, or a Makefile -D define
#define OCL_DIR "../ocl"
...
int main(int argc, char* argv[])
{
  ...
  lib_params.ocl_kernels_path = OCL_DIR ;     // <<<<< make a command line arg, or part of a config file
